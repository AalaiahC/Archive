...
(define the-grammar
  '((program (expression) a-program)
    ...
    (expression
     ("let3" identifier "=" expression identifier
             "=" expression identifier "=" expression "in" expression) let3exp)
