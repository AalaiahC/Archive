...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname A-Tire) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")) #f)))
...
(define (average-rotations a-SOT)
  (cond
    [(SOT4? a-SOT)(avr-4 a-SOT)]
    [(SOT5? a-SOT)(avr-5 a-SOT)]))

(check-within (average-rotations CAR1) 937.4 0.1)
(check-within (average-rotations CAR2) 12976.4 0.1)

;; SOT -> num
;; Purpose: computes the average number of rotations in a set of 4 tires
(define (avr-4 a-SOT)
...
(check-within (avr-4 CAR1) 937.4 0.1)

;; SOT -> num
;; Purpose: computes the average number of rotations in a set of 5 tires
(define (avr-5 a-SOT)
...
(check-within (avr-5 CAR2) 12976.4 0.1)
