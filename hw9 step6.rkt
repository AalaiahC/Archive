...
;;             (expression_app
;;              (expression_lambda
;;               (expression_app (expression_var 0) (expression_const 10)))
;;              (expression_lambda (expression_mult (expression_var 0) (expression_const 5)))))
;;       (set! env-cps (envr_empty-env))
;;       (set! k (kt_empty-k))
;;       (value-of-cps))))
...
;;     (begin
;;       (set! expr
;;              (expression_mult (expression_const 5) (expression_app (expression_lambda (expression_const 7)) (expression_const 5))))
;;       (set! env-cps (envr_empty-env))
;;       (set! k (kt_empty-k))
;;       (value-of-cps)))) 


;(mult (const 5) (app (lambda (const 7)) (const 5)))
;((lambda (h) (h (lambda (v) (* v 2)))) (lambda (f) (f 3)))
...
#|
 ...
 |#
(define-registers c-cps a k expr y v env-cps)
...
(define (apply-env) ;; env-cps y k
              ;(pretty-print (list "ccps" c-cps "a" a "k" k "expr" expr "y" y "v" v "envcps" env-cps))
